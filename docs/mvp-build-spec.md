...
| Cost analytics, MCP dashboard, knowledge graph, journal, coach, marketplace | Out of scope for this MVP entirely. **Phase 2a is now in progress** — see `docs/usage-analytics.md`: Activity (PR1), Cost (PR2), and Skills activity + session association (PR3) have landed; Model & effort / Resident-tax remain PR4–5                                                                                                                                                                                                                                                                                                                                                                                     | Per original roadmap's Phase 2+ — underway                                                                                            |
